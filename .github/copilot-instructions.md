...
□ VERSION_HISTORY.md 및 README.md 최신 버전으로 업데이트 완료
...
### 3.0 ⚡ 코드 작업 시 필수 적용 스킬 (절대 규칙)

> **모든 코드 작성 / 수정 / 리뷰 / 리팩토링 시 반드시 `karpathy-guidelines` 스킬을 읽고 적용할 것**
> - 과도한 변경 금지 (필요한 줄만 수정할 것)
> - 요청하지 않은 기능·추상화·리팩토링 추가 절대 금지
> - 가정(assumption)을 외부에 노출하고, 불확실하면 먼저 질문할 것
> - 성급한 결론 금지 — 계획을 먼저 설명하고 검증 가능한 성공 기준을 정의할 것
...
| 💻 3️⃣ | karpathy-guidelines 스킬 필독 + SOLID·DRY·Clean Architecture 강제 |
